...
#for a in range(7,37000):
        
#    tickers = obtain_list_of_db_tickers()  
#    tickers_new =  list(itertools.chain.from_iterable(itertools.repeat(x, 7) for x in tickers))     
#    prices_tuple = (tickers_new[a-6], test_prices[a], test_prices[a+1], test_prices[a+2], test_prices[a+3], test_prices[a+4], test_prices[a+5], test_prices[a+6])
#    prices_list_of_tuples.append(prices_tuple)
#    a = a + 7
    
#print(prices_list_of_tuples) 
    #insert_daily_prices(test_prices)
    
    #test = get_daily_historic_data_yahoo(t[1])
